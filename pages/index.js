...
const Home = ({ user }) => {
	...
	return (
		<motion.div variants={container} initial="initial" animate="visible" exit="exit" className={styles.pageContainer}>
			{loadState ? (
				...
				<div className={styles.homepageContainer}>
					<div className={styles.imgContainer}>
						...
						<button className={`${roboto.className} ${styles.button}`} onClick={() => router.push('/lobby')}>
							PLAY NOW &#62;
						</button>
					</div>
					<div className={styles.section}>
						...
						<div className={styles.sectionInfo}>
							<div className={styles.sectionTextContainer}>
								...
								<button className={roboto.className} onClick={() => router.push('/market')}>
									PULL NOW &#62;
								</button>
							</div>

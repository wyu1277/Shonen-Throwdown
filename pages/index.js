      ...
      {loadState ? (
        ...
        <div className={styles.homepageContainer}>
          ...
          <div className={styles.section}>
            <img className={styles.sectionImg} src='http://rubberslug.s3.amazonaws.com/user/3/262b639333041368802c7e7c7bbe5ff/fdoxmylygp_o.jpg' alt="soul society"/>
            <div className={styles.sectionInfo}>
              ...
              <img className={styles.cardImg} src ='https://i.imgur.com/SfS6xsj.png' alt="card art for Ichigo Kurosaki"/>
            </div>
          </div>
          <div className={styles.section}>
            <img className={styles.sectionImg} src='https://images.pexels.com/photos/172277/pexels-photo-172277.jpeg' alt="wood background"/>
            <div className={styles.sectionInfo}>

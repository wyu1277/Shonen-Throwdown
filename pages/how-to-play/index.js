      ...
      {!toggledState ? (
        <>
          ...
          <p className={`${notoSerif.className} ${styles.p}`}>
            Welcome to Capstone Card Game! This is a strategic 1v1 trading card
          ...
          <p className={`${notoSerif.className} ${styles.p}`}>
            ...
            in-game name, and select a themed starter deck from one of four
            anime series. Each starter deck contains 12 cards that you can use
            to play the game and then you can expand your collection by
            purchasing booster packs from the in-game store using the in-game
            currency. When building your deck, it's important to keep in mind
            the strengths and weaknesses of each card, as well as how they work
            together to create a cohesive strategy.
          </p>
          <h2 className={roboto.className}>Gameplay:</h2>
          <p className={`${notoSerif.className} ${styles.p}`}>
            Once you've built your deck, you're ready to start playing Capstone
            Card Game! The goal of the game is to reduce your opponent's HP to
          ...
          <ol className={`${notoSerif.className} `}>
            <li>
              Roll the Dice: To determine who goes first, both players roll a
              dice. The player with the higher roll goes first.
            </li>
            <li>
              Draw Cards: Each player draws 3 cards at the beginning of the
              game. Whenever a player plays a card, that player draws 1 card
              from their deck.
            </li>
            <li>
              ...
              attribute such as red, blue, or green and an attack value ranging
              from 1 to 5.
            </li>
            <li>
              Battle: Once you've played a card, your opponent can choose to
              play a card from their hand in response. If their card has a
              higher attribute value or a higher attack value than your card,
              they beat your card and you must now play a card to beat theirs.
              If you or your opponent cannot beat the current card played, the
              owner of the current card's opponent takes damage to their HP
              equal to the card's power.
            </li>
            <li>
              Repeat: Players take turns playing cards and battling until one
              player's HP is reduced to zero or a player runs out of cards. The
              game then ends. If a player's life was reduced to 0, their
              opponent wins. If a player runs out of cards, the player who has
              the highest HP is the winner.
            </li>
          </ol>

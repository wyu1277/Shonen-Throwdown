    ...
    >
      ...
      {!toggledState ? (
        <>
          ...
          <p className={`${notoSerif.className} ${styles.p}`}>
          To get started, you'll need to create an account with a unique in-game name. You'll be given a starter deck containing 12 cards that you can use to play the game and then you can expand your collection by purchasing booster packs from the in-game store using the in-game currency. When building your deck, it's important to keep in mind the strengths and weaknesses of each card, as well as how they work together to create a cohesive strategy.
          </p>
          ...
          <ol className={`${notoSerif.className} ${styles.p} `}>
            ...
            Play Cards: On your turn, you can play one card from your deck by placing it in a designated space in front of you. Each card has an element such as red, blue, or green and an attack power ranging from 1 to 5.Red beats Green, Green beats Blue, and Blue beats Red. If the elements of both cards are tied, the card with the higher power value wins. If both the elements and power values are tied, no card wins.
            </li>
            <li className={`${notoSerif.className} ${styles.p} `}>
            Battle: When both players have played a card, they are revealed and compared. If one card beats the other based on element and power, the difference in power between the two cards is dealt to the loser's HP.
            </li>
            <li className={`${notoSerif.className} ${styles.p} `}>
            Repeat: Players take turns playing cards and battling until one player's HP is reduced to zero or if there are no more available cards to play. The game then ends. The winner at the end of the game is the player with the higher HP total. If that is tied, the game ends in a draw.
            </li>
          </ol>

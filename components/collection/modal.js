      ...
      <div className={`backdrop ${styles.pageParent}`}>
        ...
        {dupCard ? (
          <p className={styles.message}>
            Cannot have more than 1 of the same card in your deck!
          </p>
        ) : null}
        {addSuccess ? (
          <p className={styles.goodMessage}>Card added to deck!</p>
        ) : null}
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        >
          ...
          <img
            src={props.card.cards.image}
            alt={props.card.cards.name}
